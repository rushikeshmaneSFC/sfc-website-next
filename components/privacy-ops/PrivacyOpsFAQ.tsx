...
import { FAQ_ITEM } from "@/constants/PrivacyOpsConstant";

const PrivacyOpsFAQ = () => {
  return (
    <Wrapper className="flex justify-center items-center lg:py-20 py-10">
      <div className="flex flex-col space-y-8">
        <p className="lg:text-[28px] lg:leading-10 text-xl text-[#1F1F1F] font-bold">
